                        ...
                        <tbody>
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ route('invoices.show', $invoice->id) }}">{{ $invoice->category->sections_name }}</a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('paymentStatus',$invoice->id) }}"><i
...
@include('Dashboard.invoices.includes.deleteModel')
@include('Dashboard.invoices.includes.archiveModel')
<!-- row closed -->
</div>
<!-- Container closed -->
</div>
