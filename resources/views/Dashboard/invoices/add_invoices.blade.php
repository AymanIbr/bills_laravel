                    ...
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" value="{{ old('invoice_number') }}" class="form-control" id="inputName" name="invoice_number"
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" value="{{ date('Y-m-d') }}" name="Due_date" placeholder="YYYY-MM-DD"
                                    type="text" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" value="{{ old('product') }}" name="product" class="form-control">
                                </select>
                            </div>
