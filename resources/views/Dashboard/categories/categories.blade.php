...
@section('content')
    ...
    <div class="row">
        ...
        <!-- Basic modal -->
        @include('Dashboard.categories.include.createModela')
        @include('Dashboard.categories.include.updateModela')
        @include('Dashboard.categories.include.deleteModela')
        <!-- End Basic modal -->
        <!--/div-->
    </div>
    <!-- row closed -->
