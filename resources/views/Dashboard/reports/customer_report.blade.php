    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('Search_customers') }}" method="POST" autocomplete="off">
                    @csrf

                    <div class="row">
                        <div class="col">
                            <label for="inputName" class="control-label">القسم</label>
                            <select name="category_id" class="form-control select2" onclick="console.log($(this).val())"
                        ...
                        <tbody>
                            @foreach ($details as $invoice)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->category->sections_name }}</a>
                                    </td>
